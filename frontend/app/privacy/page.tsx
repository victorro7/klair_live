...
const privacyHtml = `<h1>Privacy Policy</h1>
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Klair.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Klair, accessible from <a href="klair.live" target="_blank">klair.live</a>.</p>
</li>
<li>
...
<ul>
<li>By email: victorosunji@gmail.com</li>
</ul>`;
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-[family-name:var(--font-inter)] overflow-x-hidden selection:bg-purple-500/30">
      ...
      <nav className="fixed top-6 left-0 right-0 z-50 pointer-events-none transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="pointer-events-auto bg-black/50 backdrop-blur-xl border border-white/10 rounded-full p-1.5 flex items-center shadow-2xl">
            <Link href="/" className="px-5 py-2 flex items-center gap-2 rounded-full text-xs font-medium uppercase tracking-widest text-gray-400 hover:text-white hover:bg-white/5 transition-all">
      ...
      <main className="relative pt-32 pb-16 px-6 z-10">
        <div className="max-w-4xl mx-auto">
          <div className="p-8 md:p-12 rounded-3xl border border-white/10 bg-black/40 backdrop-blur-2xl shadow-[0_0_60px_-10px_rgba(168,85,247,0.1)]">
            <div
              className="prose prose-invert max-w-none
                [&>h1]:text-4xl [&>h1]:md:text-6xl [&>h1]:font-light [&>h1]:mb-6 [&>h1]:tracking-tight [&>h1]:bg-clip-text [&>h1]:text-transparent [&>h1]:bg-gradient-to-b [&>h1]:from-white [&>h1]:via-white [&>h1]:to-gray-500
                [&>h2]:text-2xl [&>h2]:font-light [&>h2]:mt-12 [&>h2]:mb-6 [&>h2]:text-white [&>h2]:border-b [&>h2]:border-white/10 [&>h2]:pb-4
                [&>h3]:text-xl [&>h3]:font-medium [&>h3]:mt-8 [&>h3]:mb-4 [&>h3]:text-gray-200
                [&>h4]:text-lg [&>h4]:font-medium [&>h4]:mt-6 [&>h4]:mb-3 [&>h4]:text-gray-300
                [&>p]:text-gray-400 [&>p]:leading-relaxed [&>p]:mb-6
                [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:text-gray-400 [&>ul]:mb-6 [&>ul>li]:mb-4
                [&>ul>li>p]:mb-2 [&>ul>li>p:last-child]:mb-0
                [&>ul>li>strong]:text-gray-200
                [&_strong]:text-gray-200
                [&_a]:text-purple-400 [&_a]:hover:text-purple-300 [&_a]:transition-colors [&_a]:underline [&_a]:underline-offset-4"
